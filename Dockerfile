...
# Use gunicorn for production deployment with Starter Plan optimization
CMD gunicorn --workers 2 --timeout 180 --bind 0.0.0.0:${PORT:-8080} --worker-class sync wsgi:application
